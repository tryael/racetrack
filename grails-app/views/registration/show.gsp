        ...
        <div class="body">
            ...
            <div class="buttons">
                <g:form>
                    ...
                    <span class="button"><g:actionSubmit class="delete" action="delete" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return warnBeforeRegistrationDelete();" /></span>
                </g:form>
            </div>
        </div>
    </body>
